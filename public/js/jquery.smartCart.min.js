...
! function (t, e, a, i) {
    ...
    var r = {
        ...
        combineProducts: !0,
        highlightEffect: !0,
        cartItemTemplate: ' <div style="flex:auto;" class="d-flex align-items-center justify-content-around"><span>{product_desc}</span ><span style="direction: rtl">{product_name}</span> <span>{product_unit}</span><span style="direction: rtl">{product_color}</span></div>  ',
        ...
        lang: {
            cartTitle: "تعداد محصول انتخاب شده :",
            checkout: "چاپ فاکتور",
            clear: "پاک کردن فاکتور",
            subtotal: "جمع فاکتور :",
            cartRemove: "×",
    ...
    t.extend(s.prototype, {
        ...
        _setElements: function () {
            ...
            this.cart_element.append(e), this.cart_element.addClass("panel panel-default sc-cart sc-theme-" + this.options.theme),this.cart_element.append('<div class="panel-heading sc-cart-heading">' + this.options.lang.cartTitle + ' <span class="sc-cart-count badge">0</span></div>'),this.cart_element.append('<div style="width: 98%;padding: 5px;background:#eaeaea" class="d-flex mt-4   ml-auto font-weight-bold justify-content-around"  ><span>فی</span><span>نام کارخانه</span><span>نام لوله</span><span>واحد</span><span>نوع لوله</span></div>'), this.cart_element.append('<div class="list-group sc-cart-item-list"></div>')
        },
        ...
        _hasCartChange: function () {
            t(".sc-cart-count", this.cart_element).text(this.cart.length), t(".sc-cart-subtotal", this.element).text(this._getCartSubtotal()), 0 === this.cart.length ? (t(".sc-cart-item-list", this.cart_element).empty().append(t( )), t(this.options.productContainerSelector).removeClass("sc-added-item"), t(".sc-cart-checkout, .sc-cart-clear").addClass("disabled"), this._triggerEvent("cartEmpty")) : (t(".sc-cart-item-list > .sc-cart-empty-msg", this.cart_element).remove(), t(".sc-cart-checkout, .sc-cart-clear").removeClass("disabled")), t("#" + this.options.resultName, this.cart_element).val(JSON.stringify(this.cart))
        },
